            ...
            child: Expanded(
              child: Row(
                children: <Widget>[
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(bottom: MyDim.paddingUnit * 1.2),
                    child: Container(
                      child: Column(
                        children: [
                          Image.asset(
                            'Assets/images/BankCertificate.jpeg',
                            width: MyDim.myWidth(context) * 0.3,
                            height: MyDim.myHeight(context) * 0.2,
                          ),
                          IconButton(
