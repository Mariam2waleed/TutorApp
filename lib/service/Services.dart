...
import 'package:tutor/service/EndPoints.dart';
...
class AuthServices {
  ...
  //   try {
  //     final statusCode = await Network.postRequest(
  //         EndPoints.changePassword, jsonEncode({'newPassword': newPassword}));
  //     if (statusCode == 201) {
  //       return true;
  //     }
  //   } catch (e) {
